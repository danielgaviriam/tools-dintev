...
class Tools_Table extends WP_List_Table {
    ...
    */
    function __construct() {
      ...
      'singular'=> 'wp_list_tools', //Singular label
      'plural' => 'wp_list_test_tools', //plural label, also this well be one of the table css class
        ...
        foreach($records as $rec){
          ...
          foreach ( $columns as $column_name => $column_display_name ) {
             ...
             switch ( $column_name ) {
                ...
                case "col_url": echo '< td '.$attributes.'>'.stripslashes($rec->link).'< /td>'; break;
             }
          }
