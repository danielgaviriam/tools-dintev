...
require_once plugin_dir_path(__FILE__) . 'includes/lib.php';
	...
	function td_start_plugin(){
        add_menu_page( 'Agregar Herramienta', 'Tools Dintev', 'manage_options', 'Tools Dintev', 'td_form_tool' );
        add_submenu_page( 'Tools Dintev', 'Agregar Categoria', 'Add Categoria', 'manage_options', 'Add Category' ,'td_form_category');
        add_submenu_page( 'Tools Dintev', 'Agregar Categoria', 'Show Tools', 'manage_options', 'Add Category' ,'td_get_info_tool');
        }